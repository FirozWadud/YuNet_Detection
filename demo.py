...
if __name__ == '__main__':
    ...
    if args.input is not None:
        ...
        deviceId = 2   #"rtsp://admin:admin123@192.168.0.150:554/cam/realmonitor?channel=1&subtype=0&unicast=true&proto=Onvif"
        ...
        frame_counter = 0
        drop_rate = 3  # Adjust the frame drop rate as needed
